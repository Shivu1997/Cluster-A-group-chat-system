...
<div class="container-fluid Friends" id="F" style="background-color: #BDC581;">  
<div class="InsideFriends2" style="background-color: #BDC581;">';
require 'php/friendhelper2.php';
echo '</div>
<div class="InsideFriends" style="background-color: #BDC581;">
<h2>Requests</h2>';
